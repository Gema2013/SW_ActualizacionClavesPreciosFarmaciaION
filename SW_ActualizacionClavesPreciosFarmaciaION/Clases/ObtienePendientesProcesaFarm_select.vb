...
Namespace SP_BBDD
    ...
    Public Class ObtienePendientesProcesaFarm_select

        Public Sub New()
            MyBase.New()
        End Sub

        Public Overridable Function ObtienePendientesProcesaFarm_select(ByVal connection As System.Data.SqlClient.SqlConnection, ByVal transaccion As System.Data.SqlClient.SqlTransaction, ByVal table As System.Data.DataTable
                                                       )
            ...
            Else
                ...
                If (transaccion Is Nothing) Then
                    If (connection.State = System.Data.ConnectionState.Closed) Then
                        ...
                        'Abrir Conexion
                    End If
                    cmd = New System.Data.SqlClient.SqlCommand("ObtienePendientesProcesaFarm_select", connection)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                Else
                    cmd = New System.Data.SqlClient.SqlCommand("ObtienePendientesProcesaFarm_select", connection, transaccion)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                End If
