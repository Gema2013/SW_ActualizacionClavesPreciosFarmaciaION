...
Namespace SP_BBDD
    ...
    Public Class ActualizaPendientesProcesaFarm_update

        Public Sub New()
            MyBase.New()
        End Sub

        Public Overridable Function ActualizaPendientesProcesaFarm_update(ByVal connection As System.Data.SqlClient.SqlConnection, ByVal transaccion As System.Data.SqlClient.SqlTransaction, ByVal table As System.Data.DataTable,
            ...
            Else
                ...
                If (transaccion Is Nothing) Then
                    If (connection.State = System.Data.ConnectionState.Closed) Then
                        ...
                        'Abrir Conexion
                    End If
                    cmd = New System.Data.SqlClient.SqlCommand("ActualizaPendientesProcesaFarm_update", connection)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                Else
                    cmd = New System.Data.SqlClient.SqlCommand("ActualizaPendientesProcesaFarm_update", connection, transaccion)
                    cmd.CommandType = System.Data.CommandType.StoredProcedure
                End If
                ...
                cmd.Parameters.Add("@ClaveUsuario", System.Data.SqlDbType.VarChar)
                cmd.Parameters("@ClaveUsuario").Direction = System.Data.ParameterDirection.Input
                cmd.Parameters("@ClaveUsuario").Value = ClaveUsuario
