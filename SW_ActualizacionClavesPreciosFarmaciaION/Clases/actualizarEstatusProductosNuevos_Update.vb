...
Namespace SP_BBDD
    ...
    Public Class ActualizaPreciosMedicamentos_UpdateInsert
        ...
        Public Overridable Sub ActualizaPreciosMedicamentos_UpdateInsert(ByVal connection As MySqlConnection,
            ...
            Else
                ...
                If (transaccion Is Nothing) Then
                    If (connection.State = System.Data.ConnectionState.Closed) Then
                        ...
                        'Abrir Conexion
                    End If
                    cmd = New MySqlCommand("usp_catalogo_actualizarEstatusProductosNuevos", connection)
                    cmd.CommandType = CommandType.StoredProcedure
                Else
                    cmd = New MySqlCommand("usp_catalogo_actualizarEstatusProductosNuevos", connection, transaccion)
                    cmd.CommandType = CommandType.StoredProcedure
                End If
